	...
	theme: {
		...
		extend: {
			colors: {
				...
				conversation: {
					DEFAULT: 'hsl(var(--conversation))',
					foreground: 'hsl(var(--conversation-foreground))',
					accent: 'hsl(var(--conversation-accent))',
					border: 'hsl(var(--conversation-border))'
				},
